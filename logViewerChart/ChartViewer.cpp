...
void CStaticHelper::DrawThreshold(HDC hdc, CStatic *self)
{
	...
	Gdiplus::Pen hidePen(Gdiplus::Color(0xee, 0xee, 0xee), 10.0f);
	hidePen.SetLineJoin(Gdiplus::LineJoinRound);
	gdi.DrawLine(&hidePen, from1, to1);

	Gdiplus::PointF  from3(0, y - 5);
	Gdiplus::PointF  to3(rect.Width(), y - 5);
	Gdiplus::Pen linePen(Gdiplus::Color(0x00, 0x00, 0x00), 1.0);
