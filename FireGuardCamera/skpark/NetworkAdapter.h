...
public:
	...
	string	m_strAdtName;			///<Adapter name(instance id)
	string	m_strDescription;		///<Adapter description
	string	m_strMAC;				///<Adapter mac address	
};
...
public:
	...
	string			GetAdtMacAddr(int nIndex);	///<Get adapter mac address
};
